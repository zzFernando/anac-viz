    ...
    <details className="bg-white rounded-card border border-gray-100 shadow-card group">
      ...
      <div className="px-3 pb-3 pt-1 text-[0.75rem] text-slate-600 leading-relaxed space-y-3 border-t border-gray-100">
        ...
        <section>
          ...
          <p>
            Trabalho de mestrado PPGC/UFRGS. Código e pipeline de ingestão em
            repositório versionado. Parquets pré-computados ficam em
            <code className="font-mono mx-1 text-[0.7rem] bg-slate-100 px-1 py-0.5 rounded">data/processed/</code>
            para caber em ambientes com limite de memória (Render free tier).
          </p>
        </section>
      </div>
    </details>
